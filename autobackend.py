    ...
    def __init__(
        ...
        # ONNX Runtime and IMX
            ...
            runtime_options = {
                ...
                "advanced_options:num_cores": 1, #core_number
            }
            ...
            if onnx:
                ...
                #onnxruntime.InferenceSession(w, providers=providers)
            else:
                check_requirements(
        ...
        # TFLite or TFLite Edge TPU
            ...
            if edgetpu:  # TF Edge TPU https://coral.ai/software/#edgetpu-runtime
                ...
                delegate_options = {
                    ...
                    "artifacts_folder": artifacts,
                    "import": "no",
                    # "core_number": core_number, -> isso já estava comentado na biblioteca original, mantive o comentário
                    "advanced_options:inference_mode": 1,
                    "advanced_options:num_cores": 1, #estava 4, alterei para 1
                    "core_start_idx": 1
                }
                tidl_delegate = [
                    load_delegate(
                ...
                interpreter = Interpreter(
                    model_path=w, experimental_delegates=tidl_delegate
                )
